...
import types
import traceback
from madeirarpc.utils import getcallargs
...
def start_server(handlers, port=8080, debug=False):
    """
    ...
    USAGE:
        start_server(handler_class, port=8181)
    """
    ...
    if debug:	application.setting = {"debug"	:	"True"}
